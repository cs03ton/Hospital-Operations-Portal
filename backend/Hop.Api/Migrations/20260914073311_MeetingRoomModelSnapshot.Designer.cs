...
namespace Hop.Api.Migrations
{
    ...
    [Migration("20260914073311_MeetingRoomModelSnapshot")]
    partial class MeetingRoomModelSnapshot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hop.Api.Models.MeetingRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Hop.Api.Models.MeetingRoomAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Hop.Api.Models.MeetingRoomBooking", b =>
                {
                    ...
                    b.Property<string>("AdditionalRequest")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)")
                        .HasColumnName("additional_request");
                    ...
                    b.HasIndex("BookerId", "StartAt");

                    b.HasIndex("RoomId", "StartAt", "EndAt");

                    b.ToTable("meeting_room_bookings", (string)null);
                });

            modelBuilder.Entity("Hop.Api.Models.MeetingRoomBookingHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("meeting_room_booking_histories", (string)null);
                });
            ...
            modelBuilder.Entity("Hop.Api.Models.RepairCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("repair_categories", (string)null);
                });

            modelBuilder.Entity("Hop.Api.Models.RepairContributor", b =>
                {
                    b.Property<Guid>("EventId")
                        .HasColumnType("uuid")
                        .HasColumnName("event_id");
                    ...
                    b.ToTable("repair_contributors", (string)null);
                });

            modelBuilder.Entity("Hop.Api.Models.RepairDispatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("EventId", "TeamCode")
                        .IsUnique();

                    b.HasIndex("Status", "AvailableAt");

                    b.ToTable("repair_dispatches", (string)null);
                });

            modelBuilder.Entity("Hop.Api.Models.RepairEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Hop.Api.Models.RepairImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("repair_images", (string)null);
                });

            modelBuilder.Entity("Hop.Api.Models.RepairRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TeamCode", "Status", "CreatedAt");

                    b.ToTable("repair_requests", (string)null);
                });

            modelBuilder.Entity("Hop.Api.Models.RepairRound", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("repair_rounds", (string)null);
                });

            modelBuilder.Entity("Hop.Api.Models.RepairTeam", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                    ...
                    b.ToTable("repair_teams", (string)null);
                });

            modelBuilder.Entity("Hop.Api.Models.RepairWaitingPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("repair_waiting_periods", (string)null);
                });
            ...
            modelBuilder.Entity("Hop.Api.Models.MeetingRoomBooking", b =>
                {
                    ...
                    b.HasOne("Hop.Api.Models.Department", null)
                        .WithMany()
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Hop.Api.Models.MeetingRoom", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Hop.Api.Models.RepairCategory", b =>
                {
                    b.HasOne("Hop.Api.Models.RepairTeam", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Hop.Api.Models.RepairContributor", b =>
                {
                    b.HasOne("Hop.Api.Models.RepairEvent", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Hop.Api.Models.RepairDispatch", b =>
                {
                    ...
                    b.HasOne("Hop.Api.Models.RepairRequest", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Hop.Api.Models.RepairRequest", b =>
                {
                    b.HasOne("Hop.Api.Models.RepairCategory", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
