...
- เพิ่ม Dashboard แจ้งซ่อม การตั้งค่าประเภท และการแจ้งเตือนผ่านกลุ่มส่วนกลางตามทีม
...
## 🆕 อัปเดตการใช้งานปัจจุบัน

- ระบบลาแสดงวันที่ พ.ศ. และเก็บวันที่ ค.ศ.; ลาพักผ่อนต้องส่งล่วงหน้า 3 วันปฏิทิน พยาบาลนับทุกวัน ส่วนหน่วยงานอื่นตัดเสาร์–อาทิตย์และวันหยุดที่เปิดใช้งาน
- คำขอรถรองรับผู้ขอเดินทางคนเดียว เบอร์โทรจากข้อมูลพนักงาน และเอกสารประกอบสูงสุด 2 ไฟล์ ผู้จัดรถเป็นผู้เลือกรถและคนขับ
- หน้าตั้งค่ารถและคนขับรองรับเพิ่ม แก้ไข ปิดและเปิดใช้งาน พร้อมข้อมูลใบขับขี่ โดยเก็บประวัติงานเดิม
- Dashboard ห้องประชุมแสดงรูปห้อง สถานะปัจจุบัน ตารางและกราฟรายวัน ฟอร์มจองระบุผู้เข้าประชุมที่ทราบชื่อหรือจำนวนรวมได้ และทะเบียนห้องแสดงเป็นการ์ดพร้อมรูป
- แจ้งซ่อมดึงชื่อและเบอร์ผู้แจ้งจากข้อมูลส่วนตัว กลุ่มแจ้งเตือนของงานซ่อมและรถใช้หน้ากลุ่มแจ้งเตือนส่วนกลาง กลุ่มแจ้งซ่อมเดิมแสดงเพื่อการตรวจสอบจนกว่าจะย้ายข้อมูล
