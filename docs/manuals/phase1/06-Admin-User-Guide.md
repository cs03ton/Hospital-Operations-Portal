...
12. [การจัดการประกาศและสื่อประกอบ](#การจัดการประกาศและสื่อประกอบ)
13. [Checklist สำหรับ Admin](#checklist-สำหรับ-admin)
...
## การจัดการประกาศและสื่อประกอบ

ผู้ดูแลระบบที่มีสิทธิ์ `Announcement.Manage` สามารถสร้างประกาศ เพิ่มรูปหน้าปก รูปประกอบ และไฟล์แนบได้

1. ไปที่เมนู `ศูนย์ประกาศ` หรือ `จัดการประกาศ`
2. กด `เพิ่มประกาศ`
3. กรอกหัวข้อ สรุป และเนื้อหาประกาศ
4. เลือกความสำคัญ หมวดหมู่ เวลาเผยแพร่ และกลุ่มเป้าหมาย
5. ในส่วน `รูปภาพและไฟล์แนบ` สามารถเพิ่มข้อมูลต่อไปนี้
   - รูปหน้าปก 1 รูป สำหรับแสดงใน Card และหน้ารายละเอียด
   - รูป Gallery หลายรูป สำหรับแสดงในหน้ารายละเอียด
   - ไฟล์แนบ เช่น PDF, DOCX, XLSX, PPTX, ZIP
6. เลือก `ช่องทางแจ้งเตือนประกาศ`
   - `Notification Bell` สำหรับแจ้งเตือนในระบบ
   - `LINE Official Account` สำหรับส่ง LINE ให้ผู้ที่เชื่อมต่อ LINE แล้ว
   - หากไม่เลือกช่องทางใด ประกาศยังแสดงในศูนย์ประกาศตามปกติ
7. ตรวจสอบ preview ก่อนบันทึก
8. กด `บันทึกข้อมูล`
9. หากต้องการเผยแพร่ ให้กลับไปหน้าจัดการประกาศแล้วกดเผยแพร่ ระบบจะแสดง preview จำนวนผู้รับก่อนยืนยัน

> **Note:** ระบบรองรับ JPG, PNG, WebP และไฟล์เอกสารขนาดไม่เกิน 10 MB ต่อไฟล์ ไฟล์ทุกไฟล์จะผ่านการตรวจสอบความปลอดภัยก่อนบันทึก

> **Warning:** หากอัปโหลดไฟล์ไม่สำเร็จ แต่ประกาศถูกบันทึกแล้ว ให้เปิดประกาศในหน้าแก้ไขและอัปโหลดไฟล์ใหม่อีกครั้ง

> **Tip:** หากเป็นประกาศเร่งด่วน ควรเลือกทั้ง `Notification Bell` และ `LINE Official Account` เพื่อเพิ่มโอกาสที่เจ้าหน้าที่จะเห็นประกาศทันเวลา
...
## การตั้งต้นสิทธิ์ลาเมื่อเพิ่มผู้ใช้

เมื่อ Admin เพิ่มผู้ใช้ใหม่ ระบบจะตั้งต้นสิทธิ์ลาให้อัตโนมัติเมื่อข้อมูลครบดังนี้:

1. ผู้ใช้เปิดใช้งาน
2. ระบุประเภทพนักงาน
3. ระบุวันที่เริ่มงาน
4. ประเภทลามีการใช้ยอดคงเหลือ
5. มี policy rule สำหรับประเภทพนักงานนั้น

> **Note:** หากข้อมูลไม่ครบ ระบบจะไม่สร้างยอดวันลา และจะบันทึก audit ไว้เพื่อให้ตรวจสอบภายหลัง

> **Warning:** การแก้ไขประเภทพนักงานหรือวันที่เริ่มงานของผู้ใช้เดิมจะไม่คำนวณยอดเดิมทับให้อัตโนมัติ เพื่อป้องกันการแก้ประวัติผิดพลาด ให้ตรวจสอบยอดในเมนู `วันลาคงเหลือ` และทำรายการปรับยอดพร้อมเหตุผลหากจำเป็น

Checklist ก่อนบันทึกผู้ใช้:

- [ ] ตรวจชื่อ-นามสกุลและ username
- [ ] เลือกหน่วยงานถูกต้อง
- [ ] เลือก Role ถูกต้อง
- [ ] ระบุประเภทพนักงาน
- [ ] ระบุวันที่เริ่มงาน
- [ ] ตรวจสายอนุมัติวันลา
- [ ] หลังบันทึก ตรวจวันลาคงเหลือของผู้ใช้

ดูรายละเอียดเพิ่มเติมที่ `docs/LEAVE-ENTITLEMENT-RULES.md` และ `docs/EMPLOYMENT-TYPE-CHANGE.md`
