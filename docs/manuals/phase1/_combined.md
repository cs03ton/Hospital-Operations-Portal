...
| หัวหน้างาน | งานรออนุมัติ, ลูกทีมลาวันนี้, สถิติทีม |
...
เจ้าหน้าที่ทั่วไปอาจเห็น Card `คำขอลาของฉัน` และ `วันลาคงเหลือ` ส่วนหัวหน้างานอาจเห็น Card `งานรออนุมัติของฉัน`
...
7. [Checklist ก่อนส่งคำขอลา](#checklist-ก่อนส่งคำขอลา)
8. [วิธีส่งคำขออนุมัติ](#วิธีส่งคำขออนุมัติ)
9. [วิธีติดตามสถานะ](#วิธีติดตามสถานะ)
10. [วิธียกเลิกคำขอ](#วิธียกเลิกคำขอ)
11. [วิธีดาวน์โหลด PDF ใบลา](#วิธีดาวน์โหลด-pdf-ใบลา)
12. [คำอธิบายสถานะ](#คำอธิบายสถานะ)
13. [ตัวอย่างปัญหาที่พบบ่อย](#ตัวอย่างปัญหาที่พบบ่อย)
...
> **Note:** HR อาจไม่ได้เห็นหรือแก้ไขข้อมูลทั้งหมดเสมอไป หากไม่เห็นเมนูที่ต้องใช้ ให้ตรวจสอบสิทธิ์กับผู้ดูแลระบบ
...
9. [ติดต่อใครเมื่อพบปัญหา](#ติดต่อใครเมื่อพบปัญหา)
