...
> **Note:** สิทธิ์วันลาคำนวณตามประเภทบุคลากรและอายุงานของแต่ละคน ไม่ใช้กฎ 6 เดือนกับทุกประเภทลา กฎ 6 เดือนใช้กับลาพักผ่อน ส่วนลาป่วย ลากิจ ลาคลอด และลาบวชต้องดู policy เฉพาะ
...
รายการที่ HR ควรตรวจร่วมกับยอดวันลา:

- ประเภทบุคลากร เช่น ข้าราชการ ลูกจ้างประจำ พนักงานราชการ พกส. หรือลูกจ้างชั่วคราว
- วันที่เริ่มปฏิบัติงาน
- กฎ policy ของประเภทลานั้น
- warning/note เรื่องไม่ได้รับค่าจ้างหรือเงื่อนไขพิเศษ
...
## การตรวจสอบสิทธิ์ลาและประเภทพนักงาน

HR ควรตรวจสอบข้อมูลพื้นฐานก่อนยืนยันยอดวันลา:

1. ประเภทพนักงานถูกต้อง
2. วันที่เริ่มงานถูกต้อง
3. หน่วยงานถูกต้อง
4. ระบบมี policy rule สำหรับประเภทพนักงานนั้น
5. ยอดวันลาคงเหลือแสดงตามปีงบประมาณที่ถูกต้อง

> **Note:** ระบบตั้งต้นยอดวันลาใหม่เฉพาะกรณีที่ยังไม่มียอดของปีงบประมาณนั้นอยู่แล้ว หากมีอยู่แล้วระบบจะไม่ทับยอดเดิม

> **Warning:** การเปลี่ยนประเภทพนักงาน เช่น รายวันเป็น พกส. หรือพนักงานราชการเป็นข้าราชการ ต้องมีการตรวจผลกระทบต่อยอดเดิม คำขอที่อนุมัติแล้ว และคำขอที่รออนุมัติ ก่อนปรับยอดจริง

กรณีพบข้อมูลไม่ตรง:

1. ตรวจข้อมูลผู้ใช้ใน User Management
2. ตรวจยอดในเมนูวันลาคงเหลือ
3. ตรวจประวัติคำขอลาและคำขอยกเลิกใบลา
4. ปรับยอดผ่านเมนูที่มี audit เท่านั้น
5. ระบุเหตุผลทุกครั้ง
