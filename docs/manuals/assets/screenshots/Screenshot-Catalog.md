...
| 32 | director | Executive | Executive Dashboard/Leave Report | `/reports/leaves` | `director/executive-dashboard.png` | Yes | Pending | Playwright | Director/Admin/SuperAdmin can access by executive/reporting policy |
