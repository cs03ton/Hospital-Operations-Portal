...
| director | Executive Dashboard/Leave Report | `/reports/leaves` | Hidden | `ReportManagement.View` | `GET /api/reports/leaves` | Denied | `AppRoutes.tsx:116`; `menuConfig.ts:59`; Director seed lacks report permission at `DevelopmentDataSeeder.cs:371-378` |
...
|---|---|---|---|
| Director executive report | Denied/Hidden | `AppRoutes.tsx:116`, `DevelopmentDataSeeder.cs:371-378` | Role description says executive/reporting access, but seed lacks `ReportManagement.View` |
