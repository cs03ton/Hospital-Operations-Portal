...
| Admin | System administration and HR support when explicitly assigned | `Dashboard.View`, `LeaveRequest.ViewDepartment`, `LeaveApproval.Delegate`, `LeaveApprovalDelegation.Manage`, `LeaveApprovalEscalation.Manage`, `LeaveSupport.ViewAll`, `LeaveAdmin.*`, `ReportManagement.*`, `SystemSettings.*` |
