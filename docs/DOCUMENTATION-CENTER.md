...
## คู่มือระบบข่าวสารและประกาศ

เพิ่ม slug `announcement-guide` เพื่อให้ผู้ใช้ทุกบทบาทอ่านคู่มือข่าวสารและประกาศจากหน้า `/docs` ได้โดยตรง

คู่มือนี้ครอบคลุม:

- การอ่านประกาศและกดรับทราบ
- การดูรูปหน้าปก รูปภาพประกอบ และไฟล์แนบ
- การ preview รูปภาพบนหน้าเว็บ
- การเลือกกลุ่มเป้าหมายแบบทุกคน หน่วยงาน บทบาท ผู้ใช้ และ permission
- การเลือกช่องทางแจ้งเตือน Notification Bell และ LINE Official Account
- การเผยแพร่ ตั้งเวลา จัดเก็บ ยกเลิก ทำสำเนา และลบประกาศ
