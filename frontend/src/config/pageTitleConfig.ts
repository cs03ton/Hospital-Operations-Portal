...
const pageTitleEntries: PageTitleEntry[] = [
  ...
  { path: "/admin/approval-chains/create", title: "เพิ่มสายอนุมัติวันลา", subtitle: "กำหนดลำดับการอนุมัติใหม่", exact: true, breadcrumbs: [{ label: "สายอนุมัติวันลา", path: "/admin/approval-chains" }, { label: "เพิ่มสายอนุมัติ" }] },
  { path: "/admin/approval-chains", title: "สายอนุมัติวันลา", subtitle: "จัดการผู้อนุมัติและขั้นตอนการอนุมัติ", breadcrumbs: [{ label: "สายอนุมัติวันลา" }] },
