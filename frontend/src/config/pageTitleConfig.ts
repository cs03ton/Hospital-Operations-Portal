...
const pageTitleEntries: PageTitleEntry[] = [
  ...
  { path: "/announcements", title: "ศูนย์ข่าวสารและประกาศ", subtitle: "ข่าวสารสำคัญ ประกาศภายใน และรายการที่ต้องรับทราบ", breadcrumbs: [{ label: "ศูนย์ข่าวสารและประกาศ" }] },
  { path: "/docs", title: "ศูนย์คู่มือการใช้งาน", subtitle: "รวมคู่มือ HOP ตามบทบาทและงานที่เกี่ยวข้อง", breadcrumbs: [{ label: "ศูนย์คู่มือการใช้งาน" }] },
  { path: "/profile/change-password", title: "เปลี่ยนรหัสผ่าน", subtitle: "ยืนยันรหัสผ่านปัจจุบันก่อนตั้งรหัสผ่านใหม่", exact: true, breadcrumbs: [{ label: "ข้อมูลส่วนตัวของฉัน", path: "/profile" }, { label: "เปลี่ยนรหัสผ่าน" }] },
  ...
  { path: "/admin/dashboard", title: "Admin Dashboard", subtitle: "ภาพรวมระบบและงานที่ผู้ดูแลต้องตรวจสอบ", exact: true, breadcrumbs: [{ label: "Admin Dashboard" }] },
  ...
  { path: "/admin/announcements/create", title: "เพิ่มประกาศ", subtitle: "สร้างประกาศและกำหนดกลุ่มเป้าหมาย", exact: true, breadcrumbs: [{ label: "จัดการประกาศ", path: "/admin/announcements" }, { label: "เพิ่มประกาศ" }] },
  { path: "/admin/announcements", title: "จัดการประกาศ", subtitle: "สร้าง เผยแพร่ ตั้งเวลา และติดตามประกาศภายใน", breadcrumbs: [{ label: "จัดการประกาศ" }] },
